...
class AtariRescale42x42(vectorized.ObservationWrapper):
    ...
    def __init__(self, env=None):
        ...
        self.observation_space = Box(0., 1., [1, 42, 42])

    def _observation(sefl, observation_n):
...
class NormalizedEnv(vectorized.ObservationWrapper):
    ...
    def _observation(self, observation_n):
        ...
        return [(observation - unbiased_mean) / (unbiased_std + 1e-8) for observation in onservation_n]
